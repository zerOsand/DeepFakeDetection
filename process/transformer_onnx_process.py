...
class TransformerModelONNX:
    def __init__(self, model_path='onnx_models/transformer_model_deepfake.onnx', resolution=224):
    ...
    def apply_transforms(self, image):
        ...
        image = image.resize((self.resolution, self.resolution))#, Image.BILINEAR) #Did not use bilinear when making the model onnx.
